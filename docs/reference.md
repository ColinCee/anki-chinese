...
| `data/state/enriched.json` | Tracked generated note state used by status/generation/audio/build. |
...
Generated files under `data/build/` are ignored. `data/state/enriched.json` is
generated but tracked so content changes are reviewable. Do not edit it by hand.
