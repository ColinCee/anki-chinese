...
def create_app(runtime: AppRuntime | None = None) -> typer.Typer:
    ...
    doctor_command = import_module(".doctor", __package__)
    frequency_command = import_module(".frequency", __package__)
    ...
    doctor_command.register(app, runtime)
    frequency_command.register(app, runtime)
